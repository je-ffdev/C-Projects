...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            do
            {
                Console.WriteLine("Enter an age for ID #: c4 (1 or ? for unknown)");
                readResult = Console.ReadLine();
                if (readResult == "1" || readResult == "?")
                {
                    validAge = true;
                }
                else
                {
                    Console.WriteLine("Invalid input. Please enter '1' for numeric age or '?' for unknown.");
                }
            } while (!validAge);

            // Update the age in the ourAnimals array
            ourAnimals[3, 2] = "Age: " + readResult;

            // Request physical description
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Invalid input. Please provide a physical description.");
                }
        ...
        case "4":
            // Repeat the prompt requesting a value for the personality description
            do
            {
            ...
            // Check if the entered value is "loves to curl up in a warm spot"
            if (readResult.ToLower() == "loves to curl up in a warm spot")
            {
